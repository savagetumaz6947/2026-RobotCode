...
public class PhotonVision extends SubsystemBase {
    ...
    public PhotonVision(String cameraName, Transform3d robotToCamera) {
        this(cameraName, robotToCamera, AprilTagFieldLayout.loadField(AprilTagFields.kDefaultField), Meters.of(1), 0.15);
    }

    public PhotonVision(String cameraName, Transform3d robotToCamera, AprilTagFieldLayout fieldLayout, Distance maxDistance, double maxAmbiguity) {
    ...
    public Optional<EstimatedRobotPose> getEstimatedGlobalPose(boolean overrideCheck) {
        ...
        for (var res : camera.getAllUnreadResults()) {
            ...
            if (photonPose.isPresent()) {
                ...
                if (overrideCheck || (target.getPoseAmbiguity() < maxAmbiguity && targetDistance < maxDistance.in(Meters))) {
